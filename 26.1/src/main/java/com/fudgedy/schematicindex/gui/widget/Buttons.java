...
public final class Buttons
{
	...
	public static void gold(GuiGraphicsExtractor ctx, Font font, Rect rect, String label, int mouseX, int mouseY)
	{
		boolean hovered = rect.contains(mouseX, mouseY);
		float hover = Theme.buttonHover(rect, hovered);
		float scale = Theme.buttonScale(rect, 1.0F + Theme.HOVER_SCALE * hover);
	...
	public static void mock(GuiGraphicsExtractor ctx, Font font, Rect rect, String label)
	{
	...
	public static void disabled(GuiGraphicsExtractor ctx, Font font, Rect rect, String label)
	{
		Theme.roundedRect(ctx, rect.x, rect.y, rect.width, rect.height, Theme.RADIUS_PILL, Theme.SURFACE_CARD);
	...
	public static void danger(GuiGraphicsExtractor ctx, Font font, Rect rect, String label, int mouseX, int mouseY)
	{
	...
	public static void save(GuiGraphicsExtractor ctx, Font font, Rect rect, boolean saved, int mouseX, int mouseY)
	{
		boolean hovered = rect.contains(mouseX, mouseY);
		float hover = Theme.buttonHover(rect, hovered);
		float scale = Theme.buttonScale(rect, 1.0F + Theme.HOVER_SCALE * hover);
	...
	public static void download(GuiGraphicsExtractor ctx, Font font, Rect rect, SchematicEntry entry, int mouseX,
	...
	public static void uploading(GuiGraphicsExtractor ctx, Font font, Rect rect, long startedAt)
	{
	...
	public static void cornerClose(GuiGraphicsExtractor ctx, Rect rect, int mouseX, int mouseY)
	{
		boolean hovered = rect.contains(mouseX, mouseY);
	...
	public static int stepper(GuiGraphicsExtractor ctx, Font font, Rect minus, Rect plus, String value, int x, int y,
	...
	private static void stepperButton(GuiGraphicsExtractor ctx, Rect rect, boolean plus, int mouseX, int mouseY)
	{
		boolean hovered = rect.contains(mouseX, mouseY);
		float hover = Theme.buttonHover(rect, hovered);
		float scale = Theme.buttonScale(rect, 1.0F + Theme.HOVER_SCALE * hover);
	...
	public static void arrow(GuiGraphicsExtractor ctx, Rect rect, boolean left, int mouseX, int mouseY)
	{
		boolean hovered = rect.contains(mouseX, mouseY);
		Theme.roundedRect(ctx, rect.x, rect.y, rect.width, rect.height, Theme.RADIUS_PILL,
