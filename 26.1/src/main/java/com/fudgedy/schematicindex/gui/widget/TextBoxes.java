...
public final class TextBoxes
{
	...
	public static void wrapped(GuiGraphicsExtractor ctx, Font font, int x, int y, int width, int height,
	...
	public static void caretLine(GuiGraphicsExtractor ctx, Font font, int x, int y, int width, int height,
	...
	public static void underscoreLine(GuiGraphicsExtractor ctx, Font font, int x, int y, int width, int height,
