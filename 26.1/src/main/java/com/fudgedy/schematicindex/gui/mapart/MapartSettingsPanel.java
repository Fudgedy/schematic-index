...
public final class MapartSettingsPanel
{
	...
	private int renderHelperCard(GuiGraphicsExtractor ctx, int x, int y, int width, int mouseX, int mouseY)
	{
	...
	private int renderMapSize(GuiGraphicsExtractor ctx, int x, int y, int width, int mouseX, int mouseY)
	{
		MapartOptions options = MapartSession.options;
	...
	private int renderColourSwatch(GuiGraphicsExtractor ctx, int x, int y, MapartOptions options, int mouseX, int mouseY)
	{
	...
	private void renderHex(GuiGraphicsExtractor ctx, int x, int y, int mouseX, int mouseY)
	{
	...
	public void renderPopup(GuiGraphicsExtractor ctx, Font font, int right, int bottom, int mouseX, int mouseY)
	{
		if (!this.popupOpen)
		{
			return;
	...
	private int label(GuiGraphicsExtractor ctx, String text, int x, int y)
	{
		Theme.text(ctx, this.font, text, x, y, Theme.TEXT);
		return y + LABEL_HEIGHT;
	}

	private int wrappedHint(GuiGraphicsExtractor ctx, String text, int x, int y, int width)
	{
	...
	private int slider(GuiGraphicsExtractor ctx, Rect track, String label, String value, float fraction, int id, int x, int y,
