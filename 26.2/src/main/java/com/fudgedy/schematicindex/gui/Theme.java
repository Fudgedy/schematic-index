...
public final class Theme
{
	...
	public static void roundedRect(GuiGraphicsExtractor ctx, int x, int y, int width, int height, int radius, int color)
	{
	...
	public static void roundedOutline(GuiGraphicsExtractor ctx, int x, int y, int width, int height, int radius, int color)
	{
		if (radius <= 0)
		{
	...
	public static void circleButton(GuiGraphicsExtractor ctx, int x, int y, int size, int fill, int outline)
	{
	...
	public static void chevronUp(GuiGraphicsExtractor ctx, int x, int y, int size, int color)
	{
	...
	public static void text(GuiGraphicsExtractor ctx, Font font, String value, int x, int y, int color)
	{
		ctx.text(font, value, x, y, color, false);
	}

	public static void text(GuiGraphicsExtractor ctx, Font font, Component value, int x, int y, int color)
	{
		ctx.text(font, value, x, y, color, false);
	}

	public static void textScaled(GuiGraphicsExtractor ctx, Font font, String value, int x, int y, float scale, int color)
	{
		ctx.pose().pushMatrix();
		ctx.pose().translate((float) x, (float) y);
		ctx.pose().scale(scale, scale);
		ctx.text(font, value, 0, 0, color, false);
		ctx.pose().popMatrix();
	}

	public static void textScaled(GuiGraphicsExtractor ctx, Font font, Component value, int x, int y, float scale, int color)
	{
		ctx.pose().pushMatrix();
		ctx.pose().translate((float) x, (float) y);
		ctx.pose().scale(scale, scale);
	...
	public static void pushScale(GuiGraphicsExtractor ctx, int x, int y, int width, int height, float scale)
	{
	...
	public static void pushRotate(GuiGraphicsExtractor ctx, int x, int y, int width, int height, float radians)
	{
		float centreX = x + width / 2.0F;
		float centreY = y + height / 2.0F;
		ctx.pose().pushMatrix();
	...
	public static void itemScaled(GuiGraphicsExtractor ctx, ItemStack stack, int x, int y, float scale)
	{
		ctx.pose().pushMatrix();
		ctx.pose().translate((float) x, (float) y);
		ctx.pose().scale(scale, scale);
	...
	public static void image(GuiGraphicsExtractor ctx, Identifier texture, int x, int y, int width, int height)
	{
	...
	public static void imageFlippedV(GuiGraphicsExtractor ctx, Identifier texture, int x, int y, int width, int height,
			int sourceWidth, int sourceHeight)
	{
	...
	public static void blueprintPlaceholder(GuiGraphicsExtractor ctx, int x, int y, int width, int height)
	{
	...
	public static void loadingPlaceholder(GuiGraphicsExtractor ctx, int x, int y, int width, int height)
	{
	...
	public static void goldGloss(GuiGraphicsExtractor ctx, int x, int y, int width, int height, float hover)
	{
	...
	public static void goldGradientText(GuiGraphicsExtractor ctx, Font font, String text, int x, int y, boolean bold)
	{
	...
	public static void goldGradientTextScaled(GuiGraphicsExtractor ctx, Font font, String text, int x, int y,
			float scale, boolean bold)
	{
		...
		for (int i = 0; i < text.length(); i++)
		{
			...
			int color = 0xFF000000 | lerpColor(GOLD_GRAD_FROM, GOLD_GRAD_TO, t);
			String glyph = (bold ? "§l" : "") + text.charAt(i);
			ctx.text(font, glyph, cx, 0, color, false);
			cx += font.width(glyph);
		}
	...
	public static void arrow(GuiGraphicsExtractor ctx, int x, int y, boolean left, int color)
	{
	...
	public static void flag(GuiGraphicsExtractor ctx, int x, int y, int size, int color)
	{
	...
	public static void cross(GuiGraphicsExtractor ctx, int x, int y, int size, int color)
	{
	...
	public static void downloadGlyph(GuiGraphicsExtractor ctx, int x, int y, int color)
	{
	...
	public static void eyeGlyph(GuiGraphicsExtractor ctx, int x, int y, int color)
	{
	...
	public static void trashGlyph(GuiGraphicsExtractor ctx, int x, int y, int color)
	{
	...
	public static void heart(GuiGraphicsExtractor ctx, int x, int y, boolean liked)
	{
