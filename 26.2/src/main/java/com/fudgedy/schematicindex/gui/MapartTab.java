...
public class MapartTab
{
	...
	private void renderPreview(GuiGraphicsExtractor ctx, int x, int top, int width, int bottom, int mouseX, int mouseY)
	{
	...
	private void renderPane(GuiGraphicsExtractor ctx, @Nullable Identifier texture, int boxX, int top,
	...
	private void renderGrid(GuiGraphicsExtractor ctx, int x, int y, int width, int height, int mapsX, int mapsY)
	{
	...
	private void renderOverlays(GuiGraphicsExtractor ctx, int mouseX, int mouseY, int right, int bottom)
	{
