...
public interface StaffScreen
{
	...
	void render(GuiGraphics ctx, int mouseX, int mouseY, float partialTick);

	void renderModal(GuiGraphics ctx, int mouseX, int mouseY);
	...
	int renderDetailControls(GuiGraphics ctx, SchematicEntry entry, int x, int y, int width, int mouseX,
			int mouseY);
