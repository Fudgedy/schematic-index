...
public final class MapartBlockPicker
{
	...
	private int renderPresets(GuiGraphics ctx, int x, int y, int width, int mouseX, int mouseY)
	{
	...
	private void renderRow(GuiGraphics ctx, MapPalette.Group group, int x, int y, int width, int rowHeight,
