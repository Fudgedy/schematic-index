...
public class CardMenu
{
	...
	public static void glyph(GuiGraphics ctx, int x, int y, boolean lit)
	{
	...
	private int row(GuiGraphics ctx, Font font, Rect rect, int x, int y, String label, int mouseX, int mouseY)
	{
