...
public final class Stars
{
	...
	public static void draw(GuiGraphics ctx, Font font, int x, int y, int halfStars, float scale,
	...
	private static void paint(GuiGraphics ctx, float cx, float cy, float outerR, int color)
	{
