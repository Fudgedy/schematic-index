...
class DetailRender
{
	...
	void render(GuiGraphics ctx, SchematicEntry entry, int mouseX, int mouseY)
	{
	...
	private void renderImage(GuiGraphics ctx, SchematicEntry entry, int mouseX, int mouseY,
	...
	private void renderInfo(GuiGraphics ctx, SchematicEntry entry, int mouseX, int mouseY,
			DetailView.Layout layout)
	{
		IndexScreen screen = this.view.screen;
		Font font = screen.font();
