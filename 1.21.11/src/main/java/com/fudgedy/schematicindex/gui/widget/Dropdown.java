...
public final class Dropdown
{
	...
	public void render(GuiGraphics ctx, Font font, Rect rect, String[] labels, int selected, int mouseX, int mouseY)
	{
		this.render(ctx, font, rect, labels, selected, "", mouseX, mouseY);
	}

	public void render(GuiGraphics ctx, Font font, Rect rect, String[] labels, int selected, String placeholder,
	...
	public void renderOpen(GuiGraphics ctx, Font font, int mouseX, int mouseY, int screenHeight)
	{
